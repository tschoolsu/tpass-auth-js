// T-Pass 通行證的內容契約（權威文件：tpass-auth/INTEGRATION.md §3）。
// 這個檔是「六個服務各抄一份、然後開始漂移」的那些型別的唯一版本。
 ...
 */
export type JwksCacheOptions = Pick<
  RemoteJWKSetOptions,
  "cacheMaxAge" | "cooldownDuration" | "timeoutDuration"
>;
